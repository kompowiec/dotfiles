'(erc-modules
	 '(autoaway autojoin button completion dcc fill identd irccontrols list log match menu move-to-prompt netsplit networks noncommands notify notifications page readonly replace ring scrolltobottom services smiley sound stamp spelling track unmorse xdcc image nickbar ))
